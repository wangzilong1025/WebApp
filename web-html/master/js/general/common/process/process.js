(function (b) {
        ...
        path: {
            ...
            props: {
                ...
                ruleId: {
                    ...
                    value: "",
                    editor: function () {
                        return new a.editors.selectEditor({srvId:"ICFGPROCESSFSV_QUERYPROCESSRULE",schemaData:"data.list",dataTextField:"ruleName",dataValueField:"ruleId",placeholder:"请选择规则类型"})
                    }
                },
                ruleValue: {
                    name: "ruleValue",
                    ...
                    value: "",
                    editor: function () {
                        return new a.editors.inputEditor({placeholder:"参数值用[]标记，例如[GROUP_ID]表示从参数中取集团编号"})
                    }
                },
                ruleParam: {
                    name: "ruleParam",
                    ...
                    value: "",
                    editor: function () {
                        return new a.editors.inputEditor({placeholder:"请输入规则表达式"})
                    }
                }
            }
        },
    ...
    a.rect = function (p, m) {
        ...
        this.toJson = function () {
            ...
            for (var o in E.props) {
                if(comm.lang.isArray(E.props[o].value)){
                    r += '"'+o + '":{"value":' + JSON.stringify(E.props[o].value) + '},';
                }else{
    ...
    a.props = function (h, f) {
        var j = this,
            c = b("#process_props").hide().draggable({
                handle: "#process_props_handle"
    ...
    a.editors = {
        textEditor: function () {
            ...
            this.init = function (i, h, m, l, j) {
                ...
                g = l;
                f = j;
                b('<input class="process_input k-textbox" style="width:100%;"/>').val(g.text()).change(function () {
    ...
    a.init = function (x, r) {
        ...
        b(y).data("mod", "point");
        if (a.config.editable) {
            b("#process_tools").draggable({
                handle: "#process_tools_handle"
            }).css(a.config.tools.attr);
            b("#process_tools .node").hover(function () {
                b(this).addClass("mover")
            }, function () {
                b(this).removeClass("mover")
            });
            b("#process_tools .selectable").click(function () {
                b(".selected").removeClass("selected");
                b(this).addClass("selected");
                b(y).data("mod", this.id)
            });
            b("#process_tools .state").each(function () {
                b(this).draggable({
                    helper: "clone"
                })
            });
            ...
            b("#process_save").click(function () {
                ...
                for (var c in a.config.props.props) {
                    if(comm.lang.isArray(a.config.props.props[c].value)){
                        i += '"'+c + '":{"value":' + JSON.stringify(a.config.props.props[c].value) + '},';
                    }else{
        ...
        if (r.restore) {
            ...
            if(B.props){
                for(var s in B.props.props){
                    a.config.props.props[s].value = B.props.props[s].value;
                }
            }
        }
