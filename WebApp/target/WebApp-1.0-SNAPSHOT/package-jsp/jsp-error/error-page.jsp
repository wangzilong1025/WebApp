...
<title>404错误</title>
<meta name="description" content="404页面错误" />
<style type="text/css">
html{background:url(<%=path%>/package-style/style-error/images/paper.jpg)!important;}
...
<script type="text/javascript" src="<%=path %>/package-style/style-error/js/jquery-1.4.2.min.js"></script>
<!--解决 IE6 背景缓存-->
...
<body>
    <div id="wrapper">
        <a href="<%=path %>/menu/getMenuList.do"><img src="<%=path %>/package-style/style-error/images/404_icon.png"></a>
        <div>
            <h1>唉呀!</h1>
            <p>您正在寻找的页面无法找到！！！<a style="color:#ff6600;" href="<%=path %>/menu/getMenuList.do">可能在这里！</a></p>
            <a class="link" href="/" onclick="history.go(-1)"><span id="sec">10</span> 秒后返回首页</a>
			<br /><br /><br />
        </div>
    </div>
	<script type="text/javascript">
	...
	function lazyGo() {
		...
		if (sec > 0)
			...
			window.location.href = "<%=path %>/menu/getMenuList.do";
	}
	</script>
</body>
</html>
