    ...
    <div class="scoll">
        <section class="slider">
            <div class="flexslider">
                <ul class="slides">
                    <li>
                        <img src="<%=path %>/package-style/style-front/images/01.jpg" title="pic" />
                    </li>
                    <li>
                        <img src="<%=path %>/package-style/style-front/images/02.jpg" />
                    </li>
                    <li>
                        <img src="<%=path %>/package-style/style-front/images/03.jpg" />
                    </li>
                </ul>
            </div>
        </section>
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="<%=path %>/package-style/style-front/images/01.jpg"><img src="<%=path %>/package-style/style-front/images/01_mid.jpg" alt="细节展示放大镜特效" rel="<%=path %>/package-style/style-front/images/01.jpg" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <li class="tb-selected">
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="<%=path %>/package-style/style-front/images/01_small.jpg" mid="<%=path %>/package-style/style-front/images/01_mid.jpg" big="<%=path %>/package-style/style-front/images/01.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="<%=path %>/package-style/style-front/images/02_small.jpg" mid="<%=path %>/package-style/style-front/images/02_mid.jpg" big="<%=path %>/package-style/style-front/images/02.jpg"></a>
                        </div>
                    </li>
                    <li>
                        <div class="tb-pic tb-s40">
                            <a href="#"><img src="<%=path %>/package-style/style-front/images/03_small.jpg" mid="<%=path %>/package-style/style-front/images/03_mid.jpg" big="<%=path %>/package-style/style-front/images/03.jpg"></a>
                        </div>
                    </li>
                </ul>
            </div>
...
<div class="match">
    ...
    <div class="match-comment">
        <ul class="like_list">
            <li>
                <div class="s_picBox">
                    <a class="s_pic" href="#"><img src="<%=path %>/package-style/style-front/images/cp.jpg"></a>
            ...
            <li>
                <div class="s_picBox">
                    <a class="s_pic" href="#"><img src="<%=path %>/package-style/style-front/images/cp2.jpg"></a>
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                    ...
                    <div class="details">
                        ...
                        <div class="twlistNews">
                            ...
                            <img src="<%=path %>/package-style/style-front/images/tw4.jpg" />
                            <img src="<%=path %>/package-style/style-front/images/tw5.jpg" />
                            <img src="<%=path %>/package-style/style-front/images/tw6.jpg" />
                            <img src="<%=path %>/package-style/style-front/images/tw7.jpg" />
                        </div>
                    </div>
                    <div class="clear"></div>
