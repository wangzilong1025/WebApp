						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									<div class="m-baseinfo">
										<a href="<%=path %>/customSelect.do">
											<c:choose>
									            <c:when test="${custom.customimag == null}">
					      					        <img class="am-circle am-img-thumbnail" src="<%=path %>/package-style/style-front/images/getAvatar.do.jpg"/>
									            </c:when>
									            <c:otherwise>
										            <img class="am-circle am-img-thumbnail" src="<%=path %>/user/${custom.customimag }"/>
									            </c:otherwise>
								            </c:choose>
										</a>
										<em class="s-name">(${custom.customname })<span class="vip1"></em>
							...
							<div class="m-order">
								<div class="s-bar">
									...
									<a class="i-load-more-item-shadow" href="<%=path %>/order.html">全部订单</a>
								</div>
								<ul>
									<li><a href="order.html"><i><img src="<%=path %>/package-style/style-front/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="order.html"><i><img src="<%=path %>/package-style/style-front/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="order.html"><i><img src="<%=path %>/package-style/style-front/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="order.html"><i><img src="<%=path %>/package-style/style-front/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="change.html"><i><img src="<%=path %>/package-style/style-front/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
							</div>
							<!--九宫格-->
								...
								<div class="s-content">
									<ul class="lg-list">
										<li class="lg-item">
											<div class="item-info">
												<a href="#">
													<img src="<%=path %>/package-style/style-front/images/65.jpg_120x120xz.jpg" alt="抗严寒冬天保暖隔凉羊毛毡底鞋垫超薄0.35厘米厚吸汗排湿气舒适">
												</a>
											</div>
											<div class="lg-info">
												<p>快件已从 义乌 发出</p>
										...
										<li class="lg-item">
											<div class="item-info">
												<a href="#">
													<img src="<%=path %>/package-style/style-front/images/88.jpg_120x120xz.jpg" alt="礼盒袜子女秋冬 纯棉袜加厚 女式中筒袜子 韩国可爱 女袜 女棉袜">
												</a>
											</div>
											<div class="lg-info">
												<p>已签收,签收人是青年城签收</p>
