                                ...
                                <dl id="select1">
                                    ...
                                    <div class="dd-conent">
                                        <c:forEach items="${menuList }" var="menu">
                                            <dd><a class="gettype" href="javascript:void();" onclick="type1(${menu.topId })">${menu.topName }</a></dd>
                                        </c:forEach>
                                    </div>
                                </dl>
                            </li>
                    ...
                    <div class="search-content">
                        ...
                        <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach items="${achieveList}" var="achievement">
                                        <li>
                                            <a href="<%=path%>/package-jsp/jsp-front/user-achievement.jsp">
                                                <div class="i-pic limit">
                                                    <img width="218px;" height="218px;" src="<%=path %>/achievementImage/${achievement.achievementImages}" />
                                                    <p class="title fl"><b>标题:</b>${achievement.achievementName}</p>
                                                    <p class="title fl"><b>类型:</b>${achievement.achievementTypeName}</p>
                                                    <p class="title fl"><b>时间:</b>${achievement.timeToString}</p>
                                                    <p class="price fl">
                                                        <b>作者:</b>
                                                        <strong>${achievement.userNick}</strong>
                                                    </p>
                                                </div>
                                            </a>
                                        </li>
