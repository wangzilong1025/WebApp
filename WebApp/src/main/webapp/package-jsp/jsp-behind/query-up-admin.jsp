...
<div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder">上级管理人员</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
            ...
            <tr>
                ...
                <td>
                    <c:if test="${admin.adminStatus != 0}">
                        <font color="#9acd32"><c:out value="正在使用"></c:out></font>
                    </c:if>
                    <c:if test="${admin.adminStatus == 0}">
                        <font color="#006400"><c:out value="未使用"></c:out></font>
                    </c:if>
                </td>
                <td>
