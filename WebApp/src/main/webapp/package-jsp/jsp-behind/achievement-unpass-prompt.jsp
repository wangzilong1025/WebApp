...
<div class="error-container">
    <h1>科研成果审核未通过提示</h1>
    <div class="errorcon">
        <i class="icon-smile-o"></i>审核未通过,正在跳转页面......
        <span style="display:none;">
            <i class="icon-frown-o"></i>操作失败!
        </span>
    </div>
    <h4 class="smaller">页面自动 <a id="href" href="<%=path %>/achievement/queryAllUnreleasedAchievement.do">直接跳转</a> 等待时间： <b id="wait">5</b></h4>
</div>
